...
public class LastYearFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // TODO Auto-generated method stub
        if (null == rootView) {
            rootView = inflater.inflate(R.layout.fragment_lastyear, container,
                    false);
            mChart = (LineChartView) rootView.findViewById(R.id.chart_center);
            mListView = (ListView) rootView.findViewById(R.id.lv_main_center);
